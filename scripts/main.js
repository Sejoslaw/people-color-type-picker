    ...
    types: {
        "soft-summer": {
            ...
            colors: [
                ...
                "#556B2F", "#668039", "#779543", "#88AA4D", "#99BF57", "#AAED61",
                "#483D8B", "#594DA3", "#6A5DBC", "#7B6CD4", "#8C7CED", "#9D8DFF",
                "#CD5C5C", "#D96C6C", "#E57D7D", "#F18E8E", "#FD9F9F", "#FFB0B0"
            ]
        },
        "light-summer": {
            name: "Jasne Lato (Light Summer)",
            colors: [
                "#A1C9F4", "#B2D4F6", "#C3DFF9", "#D4E9FB", "#E5F4FD", "#F6FFFF",
                "#FFB7B2", "#FFC5C1", "#FFD3D1", "#FFE1E0", "#FFEFF0", "#FFFFFE",
                "#E8AEFF", "#ECBAFF", "#F0C7FF", "#F4D3FF", "#F8E0FF", "#FCEDFF",
                "#73E6B4", "#85EABF", "#97EECA", "#A9F2D5", "#BBF6E0", "#CDFAEB",
                "#87CEEB", "#99D6EE", "#ABDEF2", "#BDE7F5", "#CEEFF9", "#E0F7FC",
                "#ECE1C3", "#EFE7CE", "#F2EDD9", "#F5F3E4", "#F8F9EF", "#FBFAFA",
                "#B0E0E6", "#C0E8EC", "#D0F0F2", "#E0F8F8", "#F0FFFF", "#FFFFFF",
                "#FFC0CB", "#FFCCD4", "#FFD9DD", "#FFE5E7", "#FFF2F2", "#FFFFFF",
                "#DDA0DD", "#E3AFE3", "#E9BFE9", "#EFCEEF", "#F5DEF5", "#FBEEFB",
                "#AFEEEE", "#BFF2F2", "#CFF6F6", "#DFF9F9", "#EFFDFD", "#FFFFFF"
            ]
        },
        "cool-summer": {
            name: "Chłodne Lato (Cool Summer)",
            colors: [
                "#20B2AA", "#3BC4BD", "#56D6D0", "#71E8E3", "#8CFAF6", "#A7FFFF",
                "#D23B68", "#DA527B", "#E26A8E", "#EA81A1", "#F299B4", "#FAB0C7",
                "#008080", "#1A9393", "#33A6A6", "#4DB9B9", "#66CCCC", "#80DFDF",
                "#663399", "#7547A3", "#855CAD", "#9470B8", "#1A1A1A", "#B399CE",
                "#98ABC5", "#A7B9D1", "#B6C7DD", "#C5D5E9", "#D4E3F5", "#E3F1FF",
                "#004B49", "#115B59", "#226B6A", "#337B7A", "#448B8B", "#559B9C",
                "#4169E1", "#5479E5", "#678AE9", "#7A9AED", "#8DAAF1", "#A0BBF5",
                "#191970", "#282882", "#383894", "#4747A6", "#5757B8", "#6666CA",
                "#4682B4", "#5992C0", "#6CA3CC", "#7FB3D8", "#92C4E4", "#A5D4F0",
                "#708090", "#7F8E9E", "#8E9CAC", "#9DAABA", "#ACC8C8", "#BCDCBC"
            ]
        },
        "soft-autumn": {
        ...
        "warm-autumn": {
            ...
            colors: [
                "#C35237", "#CC6349", "#D6745C", "#E0866F", "#EA9782", "#F4A895",
                "#E1AD01", "#E6B71F", "#EBC13D", "#F0CB5B", "#F5D579", "#FADF97",
                "#ADDFAD", "#B8E4B8", "#C3EAC3", "#CEEFCE", "#D9F4D9", "#E4F9E4",
                "#7A4B26", "#875A36", "#946A47", "#1A1A1A", "#AE8968", "#BB9979",
                "#8E2323", "#9B3434", "#A84545", "#B55656", "#C26767", "#CF7878",
                "#ED872D", "#F09543", "#F3A35A", "#F6B171", "#F9BF88", "#FCCD9F",
                "#D2691E", "#D87935", "#DE894D", "#E49964", "#EAA97B", "#F0B993",
                "#B22222", "#BC3535", "#C64949", "#D05D5D", "#DA7171", "#E48585",
                "#FF8C00", "#FF991A", "#FF033F", "#FFB34D", "#FFC066", "#FFCD80",
        ...
        "deep-autumn": {
            ...
            colors: [
                ...
                "#800000", "#8D1111", "#9A2242", "#A73333", "#B44444", "#C15555",
        ...
        "light-spring": {
            ...
            colors: [
                ...
                "#FFF700", "#FFFF33", "#FFFF66", "#FFFF99", "#FFFFCC", "#FFFFFF",
                "#98FF98", "#AAFFAA", "#BBFFBB", "#CCFFCC", "#DDFFDD", "#EEFFEE",
                "#FFFDD0", "#FFFEE0", "#FFFFF0", "#FFFFFF", "#FFFFFF", "#FFFFFF",
                "#779ECB", "#89AED9", "#9BBEEC", "#ADCEFA", "#BFDEFF", "#D1EEFF",
                "#FFD700", "#FFE033", "#FFE966", "#FFF299", "#FFFBCC", "#FFFFFF",
                "#FFA07A", "#FFAE8D", "#FFBCA1", "#FFCAB4", "#FFD8C8", "#FFE6DC",
                "#40E0D0", "#5CE5D8", "#79EAE1", "#95EFE9", "#B2F4F2", "#CFFFFB",
                "#00FF7F", "#33FF99", "#66FFB2", "#99FFCC", "#CCFFE5", "#FFFFFF"
            ]
        },
        "warm-spring": {
            ...
            colors: [
                ...
                "#996515", "#A67327", "#1A1A1A", "#C0904C", "#CD9E5E", "#DAAC71",
                "#32CD32", "#4CE34C", "#66F966", "#80FF80", "#99FF99", "#B3FFB3",
                ...
                "#FF4500", "#FF571A", "#FF6A33", "#FF7C4D", "#FF8F66", "#FFA180",
                "#7FFF00", "#91FF33", "#A4FF66", "#B6FF99", "#C9FFCC", "#DBFFFF",
                "#20B2AA", "#3BC4BD", "#56D6D0", "#71E8E3", "#8CFAF6", "#A7FFFF"
            ]
        },
        "clear-spring": {
            ...
            colors: [
                "#00F5FF", "#33F7FF", "#66F9FF", "#99FBFF", "#CCFDFF", "#FFFFFF",
                "#FF69B4", "#FF7C4D", "#FF8EC7", "#FFA1D0", "#FFB3DA", "#FFC6E3",
                "#00FF00", "#33FF33", "#66FF66", "#99FF99", "#CCFFCC", "#FFFFFF",
                "#FFEA00", "#FFED33", "#FFF066", "#FFF399", "#FFF6CC", "#FFFFFF",
                "#FF2400", "#FF3D1A", "#FF5733", "#FF704D", "#FF8A66", "#FFA380",
                "#00FFFF", "#33FFFF", "#66FFFF", "#99FFFF", "#CCFFFF", "#FFFFFF",
                "#FF00FF", "#FF33FF", "#66FF66", "#99FF99", "#CCFFCC", "#FFFFFF",
                "#1E90FF", "#3FA1FF", "#60B2FF", "#81C3FF", "#A2D4FF", "#C3E5FF",
                "#00FA9A", "#33FBAE", "#66FCC2", "#99FDD6", "#CCFEEA", "#FFFFFF",
                "#FF1493", "#FF3FAD", "#FF6BC8", "#FF96E2", "#FFC2FD", "#FFFFFF"
            ]
        },
        "clear-winter": {
            name: "Czysta Zima (Clear Winter)",
            colors: [
                "#0047AB", "#1A5AA3", "#336D9B", "#4D8093", "#66938B", "#80A683",
                "#FF00FF", "#FF33FF", "#66FF66", "#99FF99", "#CCFFCC", "#FFFFFF",
                "#00C69C", "#1AD0A7", "#33DAB1", "#4DE4BC", "#66EEC6", "#80F8D1",
                "#000000", "#111111", "#222222", "#333333", "#444444", "#555555",
                "#FFFFFF", "#FAFAFA", "#F5F5F5", "#F0F0F0", "#EBEBEB", "#E6E6E6",
                "#E60045", "#ED335E", "#F46678", "#FB9991", "#FFCCAA", "#FFCCBF",
                "#191970", "#282882", "#383894", "#4747A6", "#5757B8", "#6666CA",
                "#4169E1", "#5479E5", "#678AE9", "#7A9AED", "#8DAAF1", "#A0BBF5",
                "#0000FF", "#3333FF", "#6666FF", "#9999FF", "#CCCCFF", "#FFFFFF",
                "#8A2BE2", "#9640E5", "#A255E9", "#AE6AED", "#BA7FF0", "#C694F4"
            ]
        },
        "cool-winter": {
            name: "Chłodna Zima (Cool Winter)",
            colors: [
                "#ACE5EE", "#BCECEF", "#CCF2F1", "#DDF9F3", "#EEFFFF", "#FFFFFF",
                "#4169E1", "#5479E5", "#678AE9", "#7A9AED", "#8DAAF1", "#A0BBF5",
                "#0F52BA", "#2461C1", "#3A71C9", "#5080D0", "#6590D8", "#7BA0DF",
                "#FFDDF4", "#FFE3F7", "#FFE9FA", "#FFEFFD", "#FFF5FF", "#FFFFFF",
                "#4B0082", "#5A118D", "#692299", "#7933A5", "#8844B1", "#9755BC",
                "#2F4F4F", "#3C5D5D", "#4A6C6C", "#577A7A", "#658989", "#729797",
                "#000080", "#17178D", "#2E2E9A", "#4646A7", "#5D5DB4", "#7474C1",
                "#4682B4", "#5992C0", "#6CA3CC", "#7FB3D8", "#92C4E4", "#A5D4F0",
                "#C0C0C0", "#CCCCCC", "#D6D6D6", "#E0E0E0", "#EAEAEA", "#F4F4F4",
